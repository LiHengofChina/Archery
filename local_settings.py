...
environ.Env.read_env(os.path.join(BASE_DIR, "/opt/archery/.env"))
env = environ.Env(
    DEBUG=(bool, False),
    ALLOWED_HOSTS=(list, ["*"]),
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "/opt/archery/common/templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "/opt/archery/common/static"),
]
